...
//values.
func AttrGet(r *http.Request, key string) interface{} {
	v := r.Context().Value(contextKey)
	if v == nil {
		return nil
	}
...
func AttrSet(r *http.Request, key string, value interface{}) error {
	v := r.Context().Value(contextKey)
	if v == nil {
